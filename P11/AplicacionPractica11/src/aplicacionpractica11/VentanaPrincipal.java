...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void slider_rotacionStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_slider_rotacionStateChanged
        ...
        if(vi != null){
            BufferedImage img_source = img_aux;// ((LienzoImagen2D)(vi.getLienzo())).getImagen();
            if(img_source != null){
                try{
    ...
    private void boton_bandasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_bandasActionPerformed
        ...
        if(vi != null){
            ...
            if(img_source != null){
                ...
                if(img_source.getColorModel().getColorSpace().getType() == ColorSpace.TYPE_GRAY)
                    tope = 1;
    ...
    private void desplegable_csActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_desplegable_csActionPerformed
        ...
        if(vi != null){
            ...
            if(img_source != null){
                ...
                switch(opcion){
                    case "sRGB":
                        if(img_source.getColorModel().getColorSpace().getType() == ColorSpace.TYPE_YCbCr){
                        ...
                        break;
                    case "PYCC":
                        if(img_source.getColorModel().getColorSpace().getType() == ColorSpace.TYPE_RGB){
                            ColorSpace cs = ColorSpace.getInstance(ColorSpace.CS_PYCC);
                            ColorConvertOp cop = new ColorConvertOp(cs, null);
                        ...
                        break;
                    case "GRAY":
                        if(img_source.getColorModel().getColorSpace().getType() == ColorSpace.TYPE_RGB || img_source.getColorModel().getColorSpace().getType() == ColorSpace.TYPE_YCbCr){
